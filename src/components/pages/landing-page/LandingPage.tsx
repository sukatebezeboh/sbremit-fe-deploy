...
import { asset, formatCurrency, getMax, getCountriesFiltered, getRemittanceHandler, scrollTo } from '../../../util/util';
                        ...
                        <div className="hero-inner">
                            <div className="left">
                                ...
                                <div className="app-logos">
                                    <a className="app-logo-link" href="https://apps.apple.com/gb/app/sb-remit-money-transfer/id6443882446 " target="_blank" rel="noreferrer">
                                        <img src={asset('logos', 'apple.png')} alt="App Store" />
                                    </a>
                                    <a className="app-logo-link" href="https://play.google.com/store/apps/details?id=com.sbremit&gl=GB&authuser=1" target="_blank" rel="noreferrer">
                                        <img src={asset('logos', 'android.png')} alt="Google Play" />
                                    </a>
                                </div>
