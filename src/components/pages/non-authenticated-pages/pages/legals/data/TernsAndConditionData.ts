export const termAndConditionsData = [
    ...
    content: [
      {
        text: {
          "App:":
            "our mobile application for the sending of Payment Instructions.",
          "Destination Country:":
            "the country in which the Recipient receives money through the Service.",
          ...
          "Payment Instruction:":
            "a specific instruction from you requesting us to effect a Transfer.",
          "Payout Amount:":
            "the amount paid, after any foreign exchange conversion, to the Recipient’s account exclusive of the Service Fee.",
          "Recipient:":
            "someone who receives money into an account provided by a Service Provider pursuant to a Payment Instruction sent through the Service.",
          "Sender:": "someone who uses the Service to send money.",
          "Send Amount:":
            "the amount of money that the Sender wishes to send to the Recipient, excluding any applicable Service Fee and prior to any foreign exchange conversion.",
          "Service Fee:":
            "our fee (which may vary depending on the destination of the Sender and the Recipient and the Send Amount), which will be presented to you before confirming a Payment Instruction. Other taxes and charges may exist that are not paid through or imposed by us (e.g. mobile money withdrawal fees).",
          "Service Provider:":
          ...
          "Transfer History:":
            "the record of your Transfers on our App, which you may access using your email and Password registration details.",
        },
        type: "list",
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        subcontent: [
          ...
          {
            text: [
              "Our Service Fees and exchange rates are available on our website and in the App and will be presented to you in the App and website before you confirm the Transfer.",
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: [`We may delay or suspend a Transfer including:`],
        subcontent: [
          {
          ...
          {
            text: [`to validate your Payment Instruction;`],
          },
          {
            text: [
    ...
    content: [
        ...
        subcontent: [
          ...
          },
          {
            ...
            subcontent: [
              ...
              {
                text: [
                  `provide us with any other information that must be provided for a Payment Instruction to be properly executed, either when you are preparing the Payment Instruction on our App, website, or if we contact you for additional information relating to the Payment Instruction.`,
                ],
              },
            ],
          },
      ...
      },
      {
        ...
        subcontent: [
          ...
          {
            text: [
              `contacting us (at the details in the Contact section) if anyone asks you for your Password;`,
            ],
          },
          {
          ...
          {
            text: [
              `keeping your email account secure. Let us know immediately if your email address becomes compromised.`,
            ],
          },
        ],
      },
      {
        text: [
          `Contact us if you suspect your login details have been compromised. If you suspect your login or other security credentials are stolen, lost, used without your authorization or otherwise compromised, you must contact us (at the details in the Contact section below) immediately; you are also advised to change your Password. Any undue delays in notifying us may affect the security of your data (including your Payment Instrument) and also result in you being responsible for financial losses.`,
        ],
      },
      {
        text: [
      ...
      {
        text: [
          `The total amount that you will be required to pay, including the Service Fee and the relevant exchange rate, will be displayed clearly on the App or website before you are asked to confirm your Payment Instruction. Proceeding with a Payment Instruction at this point is entirely optional.`,
        ],
      },
      {
        text: [
      ...
      {
        text: [
          `For business account holders, we may at our discretion and in agreement with you accept to make onward payment to your beneficiary pending settlement at an agreed date. By signing this agreement, you have agreed to settle any outstanding amount due within 24 hours of the amount becoming due.`,
        ],
      },
      {
        text: [
          `We reserve the right to charge you a nominal administration fee of £1,000 if you do not comply with the terms of this agreement.`,
        ],
      },
      {
        text: [
          `Without prejudice to its other rights, if payment of any invoice or outstanding amount becomes overdue, the company may:-`,
        ],
        subcontent: [
          {
          ...
          {
            text: [
              `Charge and recover from you a daily outstanding charge of £15 equivalence until the amount is settled in full.`,
            ],
          },
        ],
      },
      {
        text: [
          `Where unpaid invoices remain overdue and we are forced to take legal action to recover the outstanding sums, you shall be responsible for all costs and disbursements incurred by us on a full indemnity basis.`,
        ],
      },
      {
        text: [
    ...
    content: [
      ...
      },
      {
        ...
        subcontent: [
          ...
          {
            text: [
              `you are asking for a refund of a Transfer that took place before you told us that your login was being misused;`,
            ],
          },
          {
            text: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: [
          `Your transfer history is available for download through the App or website.`,
        ],
      },
      {
        text: [
  ...
  },
  {
    ...
    content: [
      {
        text: [
          `Promotions have a set time period. Meaning there is a start and end date to every promotion`,
        ],
      },
      {
        text: [
          `To receive your discount, simply enter your promo code on the home page`,
        ],
      },
      {
        text: [
          `Promotions are subject to availability and may be withdrawn or amended without notice at any time at SB Remit's sole discretion`,
        ],
      },
      {
        text: [
          `The sender can only participate in the promotion during the promotion period and only in the manner described in the Special Terms and Conditions of Promotions. If the Participant submits his entry late, early, in a way other than the prescribed manner, or otherwise incomplete, he shall be excluded from participation without further notice`,
        ],
      },
    ],
  },
  {
    ...
    content: [
      {
        text: [
          `For referrals, the person referring shall be known as the referrer and the person being referred shall be known as the referee.`,
        ],
      },
      {
        text: [
          `The referrer will get 10 GBP or 10 CAD off their transaction if their referee’s transaction amount adds up to 200 GBP or 200 CAD irrespective of the number of transactions.`,
        ],
      },
      {
        text: [
          `The referee will get 3 GBP or 3 CAD off their next transaction if they remit GBP 200 GBP or 200 CAD within 45 days of being referred.`,
        ],
      },
      {
        text: [
          `To benefit from the referral, the amount being sent would be greater than or equal to the promo amount.`,
        ],
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        text: {
          "The transfer Fees":
            "The ‘transfer fee’ is simply how much the provider says it costs to use theirservice online. We only compare costs for online transfers remitting money fromone set country to another.",
          "The exchange rates:":
