      ...
      {openModal && (
        <ModalDiv>
          <CreationModal
            ...
            redirectLink={
              isPhoneNumber(createAccountSuccess?.username)
        ...
        <div>
          ...
          >
            ...
            <div className="inputs">
              ...
              <div className={touched.dob && errors.dob ? "form-error" : ""}>
                <div>
                  Date of Birth<i>*</i>
                </div>
                <input
              ...
              >
                ...
                {touched.referral && errors.referral && (
                  <div className="form-error-message">{errors.referral}</div>
                )}
              </div>
