                            ...
                            ({errors, touched, values}: any) => (
                                ...
                                <Form className="form">
                                    ...
                                    <div className="inputs">
                                        <div></div>
                                        <div className={"email " + ((touched.username && errors.username) ? 'form-error': '')}>
                                            <div>Email</div>
                                        ...
                                        <div className={(touched.password && errors.password) ? 'form-error': ''}>
                                            ...
                                            <Field name="password" type={passwordType} placeholder="Enter your password"/>
                                        ...
                                        <button type="submit" className="grid-col-1-0" disabled={submitting === SIGN_IN}> <span>Sign in</span>  { submitting === SIGN_IN && <ButtonLoader/>}</button>
                                    </div>
                                </Form>
                            )}
                            </Formik>
