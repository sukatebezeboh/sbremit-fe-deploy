...
export const getValueFromArray = (id: string|number, targetId: string|number, array: any[], keyToReturn?: any): any => {
    if (!array) return {};
...
export const userHasReachedFinalVerificationStage = (user: any) => {
    return user?.settings?.verificationStage === constants.VERIFICATION_STAGE_FINAL
}
